...
public:
	...
	OutputPin *GetPin() const { return (OutputPin *)pin; }

	bool ReallocateBuffers() { return pin->ReallocateBuffers(); }
	...
	int GetCX() const { return pin->GetCX(); }
	int GetCY() const { return pin->GetCY(); }
	long long GetInterval() const { return pin->GetInterval(); }
	...
	void UnlockSampleData(long long timestampStart,
				     long long timestampEnd)
	{
